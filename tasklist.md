...
current released version: v3.0.0
current released metadata: Backend 3.0.0 / Flutter 3.0.0+4 RELEASED
current v4 candidate metadata: Backend 4.0.0 / Flutter 4.0.0+5 RELEASED
previous released version: v2.1.0 RELEASED / ACCEPTED
release / annotated tag: DRC_v3.0.0
v3.0.0 status: RELEASED / ACCEPTED
...
current implementation step: DRC v4.0.0 Control E Release Publication Result Sync Corrective R5
...
```text
provider-free FW v6 RealtimeSession adapter first
installed SDK distribution: ai-character-framework
required distribution version: 6.0.0
initial FW imports from root framework only
explicit FW submodule adoption requires a separate exact review
existing accepted v3 real adapters remain retained
removal of v3 real adapters is NOT_AUTHORIZED
...
DRC-V4-6 Control A added only the default-off configured provider-free FW v6
