...
execution、audio/transcript、version、release recordを変更しない。RT-5f1は
RT-5f0受け入れ後の別exact contract reviewまで開始しない。

詳細: `docs/v300_rt5f_readiness_and_exact_split.md`。
