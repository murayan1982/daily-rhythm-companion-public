...
- [ ] real checkoutでcompileallとdedicated gateを実行
- [ ] Backend full regressionを実行
- [ ] Flutter analyze/focused/full regressionを実行
- [ ] exact surface/privacy/diffをレビュー
- [ ] 明示的なcommit承認を取得
- [ ] commit/pushは承認後のみ実行
