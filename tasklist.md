...
current implementation step: RT-5f1 default-off Backend transcript endpoint and Flutter transcript provider candidate
...
- existing transcript handoff compatibility test
...
- commit、push、operator acceptance
