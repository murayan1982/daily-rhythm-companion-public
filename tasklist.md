...
speech-triggered barge-in。RT-5eはRT-5d acceptanceまでblocked。
...
actual patchとfocused/full verificationを確認し、明示承認まではcommit/pushしない。
