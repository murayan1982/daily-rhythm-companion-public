...
Current implementation boundary: RT-4f1 is docs/test-only; no runtime behavior changes; RT-4f2 must not begin before RT-4f1 acceptance; RT-5 TTS queue/flush/barge-in remains excluded
