...
Current small commit: R-1e — explicit approval, publication, and post-publication verification (**CURRENT / NOT_COMPLETED; NOT_STARTED**)
...
Status: In progress — W-1 through W-5, C-1, T-1, and V-1 COMPLETED / ACCEPTED; R-1 CURRENT / NOT_COMPLETED
...
R-1c and R-1d are COMPLETED / ACCEPTED. The ignored private manifest validated against accepted candidate source `1e922e68685dadfc1008f1119d0ce492584e8f19`, and the exact unchanged fixed ZIP is `DailyRhythmCompanion_v2.1.0_20260725_160036.zip` from source `6e7af31f85eb6ee7887df3e184ac6a58142d6fec` with size `1747337` bytes and SHA-256 `55bf584592b1824948ec847205132582a436f2c521feb593bac914a4904074e5`. Raw screenshots and private values remain outside Git. R-1e is CURRENT / NOT_COMPLETED and NOT_STARTED; no v2.1.0 tag or GitHub Release exists.


## Historical R-1d implementation checkpoint

`build_v210_fixed_release_zip_from_head.ps1` and `scripts/check_v210_fixed_release_zip.py` define the clean-main, one-build, same-artifact boundary. Their source implementation does not itself prove that a ZIP was built or verified. R-1d remains `CURRENT / NOT_COMPLETED` and `IMPLEMENTED / NOT_ACCEPTED`; R-1e remains `PLANNED`.
...
A superseded pre-fix candidate was rejected before publication and is not part of this tuple. R-1d is `COMPLETED / ACCEPTED`; R-1e is `CURRENT / NOT_COMPLETED` and `NOT_STARTED`.
