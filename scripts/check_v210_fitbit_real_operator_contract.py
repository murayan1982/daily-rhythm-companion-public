...
def main() -> None:
    ...
    require(checklist, "Current small commit: none", "current small commit")
    require(checklist, "W-5b1  COMPLETED / ACCEPTED", "W-5b1 accepted state")
    require(checklist, "Current small-commit state: none", "W-5b current state")
    ...
    require(roadmap, "Current small commit: none", "roadmap current commit")
    ...
    print("v210_fitbit_real_operator_contract_current_small_commit: none")
