...
def main() -> None:
    ...
    require(checklist, "Current small commit: W-5b2", "current small commit")
    ...
    require(roadmap, "Current small commit: W-5b2", "roadmap current commit")
    ...
    print("v210_fitbit_real_operator_contract_current_small_commit: W-5b2")
