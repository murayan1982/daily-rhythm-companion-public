...
def main() -> None:
    ...
    require(checklist, "Current small commit: T-1a", "C-1c current small commit")
    ...
    require(roadmap, "Current small commit: T-1a", "roadmap current state")
    ...
    print("v210_post_advice_chat_inventory_current_small_commit: T-1a")
