...
def main() -> None:
    ...
    require(checklist, "Current small commit: V-1", "C-1c current small commit")
    ...
    require(roadmap, "Current small commit: V-1", "roadmap current state")
    ...
    print("v210_post_advice_chat_inventory_current_small_commit: V-1")
