...
def main() -> None:
    ...
    require(checklist, "Current small commit: T-1", "C-1c current small commit")
    ...
    require(roadmap, "Current small commit: T-1", "roadmap current state")
    require(tasklist, "current small commit: T-1 CURRENT / NOT_COMPLETED", "tasklist current state")
    ...
    print("v210_post_advice_chat_inventory_current_small_commit: T-1")
