...
def main() -> None:
    ...
    require(checklist, "Current small commit: R-1", "C-1c current small commit")
    ...
    require(tasklist, "current small commit: R-1b CURRENT / NOT_COMPLETED", "tasklist current state")
    ...
    print("v210_post_advice_chat_inventory_current_small_commit: R-1")
