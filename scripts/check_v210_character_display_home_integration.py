...
def main() -> None:
    ...
    require(checklist, "Current implementation state: IMPLEMENTED / NOT_ACCEPTED", "R-1d implementation marker")
    require(checklist, "Current small commit: R-1d", "R-1d current small commit")
