...
def verify_public_contract() -> None:
    ...
    require(release_record, "R-1d fixed ZIP build and same-artifact verification: COMPLETED / ACCEPTED", "release-record R-1d state")
    require(release_record, "source HEAD: 6e7af31f85eb6ee7887df3e184ac6a58142d6fec", "release-record R-1d source")
    ...
    require(release_record, "Status: RELEASED / ACCEPTED", "released v2.1.0 state")
    require(release_notes, "Status: RELEASED", "released v2.1.0 notes")
...
def main() -> None:
    ...
    print("v210_final_smartphone_web_evidence_current_small_commit: none")
    print("v210_final_smartphone_web_evidence_parent_phase: R-1-completed-accepted")
    ...
    print("v210_final_smartphone_web_evidence_fixed_zip_built: true")
    print("v210_final_smartphone_web_evidence_tag_created: true")
    print("v210_final_smartphone_web_evidence_github_release_created: true")
