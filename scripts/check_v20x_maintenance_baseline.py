...
def main() -> None:
    ...
    for relative in ("README.md", "roadmap.md", "tasklist.md", "scripts/README.md"):
        ...
        require(files[relative], "M-5", f"{relative} accepted M-5 state")
    ...
    require(files["tasklist.md"], "Status: COMPLETED", "task list M-5 completion")
    ...
    require(checklist_text, "Current small commit: none (M-5 accepted; M-6 planned)", "maintenance idle state")
    ...
    m5 = section_between(checklist_text, "# M-5", "# Planned queue")
