...
def main() -> None:
    ...
    require(checklist, "Current small commit: T-1b", "W-5 current commit")
    ...
    print("v210_sleep_provider_selection_current_small_commit: T-1b")
    ...
    print("v210_sleep_provider_selection_source_labels_w5b1_completed_accepted: True")
    print("v210_sleep_provider_selection_source_labels_w5b2_completed_accepted: True")
