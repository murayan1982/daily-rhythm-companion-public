...
def main() -> None:
    ...
    require(checklist, "Current small commit: T-1c", "current small commit")
    require(checklist, "T-1b  COMPLETED / ACCEPTED", "T-1b accepted state")
    require(checklist, "T-1c  CURRENT / NOT_COMPLETED", "T-1c queue state")
    require(checklist, "Status: IMPLEMENTED / NOT_ACCEPTED", "T-1c implementation status")
    require(checklist, "V-1  PLANNED", "V-1 state")
    require(checklist, "R-1  PLANNED", "R-1 state")
    require(contract, "Status: IMPLEMENTED / NOT_ACCEPTED", "detailed contract status")
    require(contract, "Parent phase: T-1 CURRENT / NOT_COMPLETED", "parent state")
    require(inventory, "T-1c implementation follow-up", "inventory follow-up")
    require(controller_contract, "T-1c implementation follow-up", "controller follow-up")
    ...
    print("v210_tts_player_home_integration_status: implemented-not-accepted")
    print("v210_tts_player_home_integration_current_small_commit: T-1c")
    print("v210_tts_player_home_integration_parent_phase: T-1-current-not-completed")
    ...
    print("v210_tts_player_home_integration_real_tts_execution: false")
    print("v210_tts_player_home_integration_audible_acceptance: false")
