...
Current realtime action: review and authorize the exact RT-5c fake-only orchestration contract separately; RT-5c remains NOT_STARTED / NOT_AUTHORIZED
...
RT-5  CURRENT / NOT_COMPLETED  TTS queue/output control and interruption
  ...
  RT-5c  NOT_STARTED / NOT_AUTHORIZED  Injectable terminal-to-voice-output/player orchestration
...
cancel, or speech-triggered barge-in. RT-5c remains NOT_STARTED /
NOT_AUTHORIZED and requires a separate exact fake-only orchestration-contract
review.
