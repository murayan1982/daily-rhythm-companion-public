...
Current phase: RT-9b IMPLEMENTED / AWAITING_REVIEW
...
RT-9b intentionally leaves every artifact/publication field unfilled. RT-9c
will separately implement builder/verifier tooling; RT-9d may build and verify
one fixed ZIP after approval; RT-9e may publish only after the exact tuple is
approved.
