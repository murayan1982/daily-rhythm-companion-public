...
Current implementation step: RT-9d public docs-only fixed-ZIP tuple recording
...
Next implementation action: verify exact nine-file RT-9d Control C tuple-record candidate; commit, push, tag, and publication remain NOT_AUTHORIZED
```
...
- [x] Review this exact seven-file acceptance sync.
- [x] Obtain explicit commit approval.
- [x] Commit and push only after approval.


## RT-6a accepted implementation
...
FW v5.4.0: d313eb6acb643103fe25988720ebee5976a04f78
exact implementation surface: seven files
...
RT-6c through RT-6f authorization: false
RT-7 real adapter execution: blocked
acceptance-sync commit/push: NOT_AUTHORIZED
```

- [x] Replace the stale RT-5f4 acceptance-sync review marker with RT-6a.
- [x] Freeze existing metadata-only Backend motion-demo behavior.
- [x] Freeze existing static Flutter character presentation behavior.
- [x] Freeze released FW root-public mock-safe motion semantics.
- [x] Record DRC/FW vocabulary mismatch and require explicit mapping.
- [x] Split RT-6b through RT-6f by ownership and stop rules.
- [x] Preserve root-public-only FW integration policy.
- [x] Preserve real Live2D/VTS execution as RT-7 blocked work.
- [x] Add exact seven-file static candidate gate.
- [x] Execute compileall and dedicated gate in real checkouts.
- [x] Execute Backend full regression: 204 passed.
- [x] Execute Flutter analyze/full regression: no issues / 411 passed.
- [x] Review exact surface and changed-content privacy.
- [x] Obtain explicit commit approval.
...
- [x] Backend full 241 passed
- [x] Real checkout dedicated gate passed
- [x] Flutter analyze/full 411 regression passed
- [x] Exact ten-file/privacy review passed
- [x] Explicit commit approval obtained
- [x] Implementation committed/pushed at `17f0c46eb0b4e26e2fdf5ffd4090c15c69f4e594`
...
- [x] Exact RT-6c contract reviewed and separately authorized
- [x] Exact ten-file implementation produced
- [x] Default-off/root-public/mock-only boundary verified
- [x] External vendor FW v5.4.0 baseline and canonical commit recorded
- [x] Root-public contract and local mock smoke passed
- [x] Focused Backend 38 passed
- [x] Backend full 279 passed with 3 dependency warnings
- [x] Flutter analyze and 411 tests passed
- [x] Exact surface, privacy, and CRLF-aware diff checks passed
- [x] Explicit commit approval obtained
- [x] Implementation commit/push and clean-tree verification completed
- [x] RT-6c recorded as COMPLETED / ACCEPTED / PUSHED
- [x] RT-6d moved to exact-contract-review readiness only
- [x] Review RT-6d exact contract separately
- [x] Authorize RT-6d implementation separately
...
- [x] Add bounded Flutter lifecycle/cue/intent/status enums.
- [x] Add public-safe request, command result, aggregate result, problem, and state.
- [x] Strictly validate the RT-6c normalized mock-only result.
- [x] Enforce maximum three commands and twelve event types.
- [x] Add injected fake/in-memory transport client only.
- [x] Add single-active-request ChangeNotifier controller.
- [x] Ignore stale completion after reset, close, and dispose.
- [x] Add client/controller focused tests.
- [x] Preserve HomeScreen, main.dart, Backend, dependencies, assets, and vendor.
- [x] Add exact twelve-file static candidate gate.
- [x] Run compileall and dedicated gate in the real checkout.
- [x] Run Backend full regression: 279 passed with 3 dependency warnings.
- [x] Run Dart format and Flutter analyze.
- [x] Run focused Flutter: 41 passed.
- [x] Run Flutter full regression: 452 passed.
- [x] Review exact surface, privacy, and CRLF-aware diff.
- [x] Obtain explicit commit approval.
...
- [x] Verify and accept the RT-6e candidate.
...
## RT-6e accepted implementation

```text
RT-6: CURRENT / NOT_COMPLETED
RT-6e: COMPLETED / ACCEPTED / PUSHED
DRC baseline: 8d69b539e974ba71fde5d9b15dd951d0c670b7ff
...
- [x] optional HomeScreen controller factory and owned lifecycle
- [x] default-unconfigured normal startup and default-off session opt-in
- [x] explicit one-request manual apply and local-only reset/opt-out
- [x] fixed source event type with no source session/turn IDs
- [x] public-safe normalized mock-motion panel
- [x] fake/in-memory widget coverage
- [x] no main.dart, Backend, RT-6d runtime, dependency, or vendor change
- [x] compileall and dedicated gate
- [x] Backend 279 / Flutter focused 16 / Flutter full 468
- [x] lifecycle dropdown structural corrective
- [x] exact surface, privacy, format, analyze, and CRLF-aware diff review
- [x] explicit implementation commit approval, push, and clean tree
- [x] RT-6f moved to exact-contract-review readiness only
- [ ] RT-6f implementation remains separately unauthorized
- [ ] acceptance-sync commit/push remains separately unauthorized
...
- [x] Freeze the exact nineteen-file Backend/Flutter/docs/static-gate surface.
- [x] Add separate Backend and Flutter default-off flags.
- [x] Add strict manual-only Backend presentation request model and route.
